...
class WorkBook {
  ...
  async listen() {
    document.addEventListener('click', (e) => {
      ...
      if (target.id === 'a1') {
        this.changeColorThem(colorThemes.a1);
      } else if (target.id === 'a2') {
        this.changeColorThem(colorThemes.a2);
      } else if (target.id === 'b1') {
        this.changeColorThem(colorThemes.b1);
      } else if (target.id === 'b2') {
        this.changeColorThem(colorThemes.b2);
      } else if (target.id === 'c1') {
        this.changeColorThem(colorThemes.c1);
      } else if (target.id === 'c2') {
        this.changeColorThem(colorThemes.c2);
